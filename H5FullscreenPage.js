(function () {
    ...
    function initDom(opt) {
        ...
        if (opt.useMusic) {
            ...
            $('body').append('<span class="music "><audio id="audio" src=' + src + ' ' + autoplay + ' ' + loopPlay + '></audio></span>');
            // $('body').append('<span class="music"><audio id="audio" src=' + src + ' autoplay="autoplay" ' + loopPlay + '></audio></span>');
            // 手动触发音乐播放
